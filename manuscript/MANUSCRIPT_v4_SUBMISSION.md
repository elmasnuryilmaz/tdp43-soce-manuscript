...
Viability was measured 48 h after seeding with the WST-1 assay (Premix WST-1, Takara Bio, cat. no. MK400). Cells were seeded at 10,000 per well in 100 µL in 96-well plates; after 48 h, 10 µL reagent was added for 3 h at 37 °C, and absorbance was read at 450 nm against a 620 nm reference on a Varioskan Flash reader (Thermo Scientific). The absorbance of cell-free wells containing medium and reagent was subtracted, and values were normalised to the mean of the non-targeting shRNA control. The experiment was performed three times; the values and statistics reported are those of one experiment (n = 4 wells per group).
