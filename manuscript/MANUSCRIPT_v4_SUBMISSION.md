...
SH-SY5Y cells were maintained in DMEM/F12 with L-glutamine and 15 mM HEPES, 10% FBS and penicillin–streptomycin, and were mycoplasma-tested. TARDBP was silenced with a pLKO.1-TRC lentiviral shRNA; particles were produced in HEK293T cells and transduced cells selected with puromycin. Three groups were compared: non-transduced cells, a non-targeting (scrambled) shRNA control and shTDP-43. TARDBP knockdown was measured against both control groups; the target-gene RT-qPCR, Fura-2 and WST-1 experiments compared shTDP-43 cells with the non-targeting shRNA control. Lentiviral work followed institutional biosafety rules.
...
Viability was measured at 24 h and 48 h with the WST-1 assay, normalised to the mean of the non-targeting shRNA control at the same time point (n = 4 wells).
