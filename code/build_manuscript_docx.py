...
1. Writes Tables 1-5, formatted for publication, from tables/*.csv into
   manuscript/MANUSCRIPT_v4_SUBMISSION.md between the markers <!-- table:N --> and
...
MD = f"{P}/manuscript/MANUSCRIPT_v4_SUBMISSION.md"
DOCX = f"{P}/manuscript/MANUSCRIPT_v4_SUBMISSION.docx"
TAB = f"{P}/tables"
