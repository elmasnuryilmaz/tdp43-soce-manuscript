...
FIG = os.path.join(core.OUT, "09_YAYIN_PAKETI", "figures")
...
TITLES = {"ORAI (CRAC channel)": "ORAI (CRAC channel)",
          "SERCA (Ca2+ re-uptake into ER)": "SERCA (Ca\u00b2\u207a re-uptake into ER)",
          "STIM (ER Ca2+ sensor)": "STIM (ER Ca\u00b2\u207a sensor)",
          "SOCE regulators": "SOCE regulators",
          "Mitochondrial Ca2+ uptake": "Mitochondrial Ca\u00b2\u207a uptake"}
...
ax.set_title("SOCE splicing candidates in SH-SY5Y\ngreen = confidence interval excludes zero",
             loc="left")
